...
var modalPreloader = document.querySelector('.modal--preloader'); // аргументы setupModal(modal, closeCallback, modalBtns, openCallback, noPrevDefault, preventScrollLock)
...
var initModals = function initModals() {
  ...
  if (modalPreloader) {
    Object(_utils_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalPreloader);
  }
};
...
var onEnterPress = function onEnterPress(evt, modal, callback) {
  var isEnterKey = evt.key === 'Enter' || evt.key === 'Ent';
